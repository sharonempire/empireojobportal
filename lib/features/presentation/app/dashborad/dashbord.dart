...
class _DashbordState extends State<Dashbord> {
  ...
  Widget _buildStatsRow() {
    return Row(
      children: [
        Expanded(
          child: _buildStatCard('Total Jobs Posted', '125', Icons.trending_up),
        ),
        SizedBox(width: context.rSpacing(12)),
        Expanded(child: _buildStatCard('Active Jobs', '38', Icons.trending_up)),
        SizedBox(width: context.rSpacing(12)),
        Expanded(
          child: _buildStatCard('Applications', '1023', Icons.trending_up),
        ),
      ],
    );
  }
  ...
  Widget _buildJobStatusCard(Map<String, dynamic> job) {
